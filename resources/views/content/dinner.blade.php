...
@section('content')
    <head>
        <style>
            body{
                background-image:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.4)),url('../images/Our-Food-Header.jpg');
    ...
    <body>
        ...
        <h3 style="color:rgba(255,255,255,1)">Drinks</h3>
            <select>            
                ...
                <option name="eggs" value="eggs" >Suda</option>
            </select>
        </div>
        <div class="well text-center" style="background-color:rgba(0,0,0,0.3)"> 
