...
@section('content')
    <html>
        ...
        <body style="background-image:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.4)),url('images/m.jpg');background-size:cover;height:880px">
            <h1 style="font-family:arial;color:#fff;text-align:center" >Food Categories</h1><br>
            ...
            <div class="well text-center" style="background-color:rgba(0,0,0,0.4)"> 
                <h3 style="color:rgba(255,255,255,1)">Ready meals</h3>
                <a href="/content/readymeals" class="btn btn-danger" style="width:150px">GO</a>
            </div>
        </body>
    </html> 
@endsection